...
// configuration step. It creates a namespace called `constellation`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", constellation::cmake::project_name, constellation::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", constellation::cmake::project_version);
      return EXIT_SUCCESS;
    }
